...
class SmartFluidApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: '/',
      routes: {
        '/': (context) => const _PlaceholderScreen(title: 'HOME PAGE'),
        '/register': (context) => const _PlaceholderScreen(title: 'REGISTER PAGE'),
...
class _PlaceholderScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Text('$title IN DEVELOPMENT', 
